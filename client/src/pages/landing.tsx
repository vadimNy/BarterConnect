  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="relative min-h-[100vh] flex items-center overflow-hidden bg-gradient-to-br from-[#3d4a3c] via-[#4a5a48] to-[#3d4a3c]">
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-28 pb-20 w-full">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-up stagger-4">
              <Link href={user ? "/app" : "/signup"}>
                <Button size="lg" className="bg-[#B95755] text-white hover:bg-[#a34a48] font-semibold rounded-full px-8 py-6 text-lg gap-2 shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300" data-testid="button-get-started">
                  Get Started Free
          ...
          <div className="hidden lg:block absolute right-6 top-1/2 -translate-y-1/2">
            <img src={logoPath} alt="" className="w-72 opacity-60 animate-float-slow" />
          </div>
        </div>
      ...
      <section id="how-it-works" className="bg-[#F8E1BF] relative">
        <div className="max-w-6xl mx-auto px-6 py-24 md:py-32 scroll-reveal" ref={revealRef1}>
          <div className="text-center mb-16">
            <p className="text-sm font-bold tracking-[0.2em] uppercase text-[#B95755] mb-4">Simple Process</p>
            ...
            {steps.map((step) => (
              <div key={step.num}>
                <div className="group relative bg-white rounded-3xl p-8 h-full border border-[#e8d5b8] hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-[#D99B42]/10 to-transparent rounded-bl-full transition-all duration-500 group-hover:w-40 group-hover:h-40" />
                  <div className="relative">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <span className="text-5xl font-black text-[#D99B42]/15 group-hover:text-[#D99B42]/25 transition-colors duration-300">{step.num}</span>
                    </div>
      ...
      <section className="bg-[#869C84] relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#3d4a3c]/15 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3" />
