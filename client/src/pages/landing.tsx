...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#869C84]/90 backdrop-blur-xl border-b border-white/10">
      ...
      <section className="relative min-h-[100vh] flex items-center overflow-hidden bg-gradient-to-br from-[#D99B42] via-[#c48a35] to-[#b07a2e]">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-20 -left-20 w-96 h-96 bg-[#F8E1BF]/25 rounded-full blur-3xl animate-float-slow" />
          <div className="absolute bottom-20 right-0 w-[500px] h-[500px] bg-[#3d4a3c]/15 rounded-full blur-3xl animate-float" />
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-28 pb-20 w-full">
          <div className="max-w-3xl">
            <div className="animate-fade-up">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/15 text-white/90 text-sm font-medium mb-8 backdrop-blur-sm border border-white/15" data-testid="badge-platform">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white mb-6 leading-[1.05]" data-testid="hero-heading">
                Trade Skills,
                <br />
                <span className="bg-gradient-to-r from-white via-[#F8E1BF] to-white bg-clip-text text-transparent animate-shimmer">
                  Not Cash.
                </span>
              </h1>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-up stagger-4">
              <Link href={user ? "/app" : "/signup"}>
                <Button size="lg" className="bg-[#3d4a3c] text-white hover:bg-[#4a5a48] font-semibold rounded-full px-8 py-6 text-lg gap-2 shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300" data-testid="button-get-started">
                  Get Started Free
        ...
        <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#3d4a3c] to-transparent" />
      </section>

      <section id="how-it-works" className="bg-[#3d4a3c] relative">
        <div className="max-w-6xl mx-auto px-6 py-24 md:py-32 scroll-reveal" ref={revealRef1}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {steps.map((step) => (
              <div key={step.num}>
                <div className="group relative bg-white/5 backdrop-blur-sm rounded-3xl p-8 h-full border border-white/10 hover:bg-white/10 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-[#869C84]/15 to-transparent rounded-bl-full transition-all duration-500 group-hover:w-40 group-hover:h-40" />
                  <div className="relative">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <span className="text-5xl font-black text-white/8 group-hover:text-white/15 transition-colors duration-300">{step.num}</span>
                    </div>
      ...
      <section className="bg-[#F8E1BF] relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#D99B42]/10 rounded-full blur-3xl" />
          <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-[#869C84]/10 rounded-full blur-3xl" />
        </div>
        <div className="relative max-w-6xl mx-auto px-6 py-24 md:py-32 scroll-reveal" ref={revealRef2}>
          <div className="text-center mb-16">
            ...
            <p className="text-[#6b5c56] mt-4 text-lg max-w-2xl mx-auto">
            ...
            {features.map((f) => (
              <div key={f.title} className="group">
                <div className="relative bg-white rounded-3xl p-7 border border-[#e8d5b8] hover:shadow-xl hover:border-[#D99B42]/30 transition-all duration-500 hover:-translate-y-1 h-full">
                  ...
                  <p className="text-sm text-[#6b5c56] leading-relaxed">{f.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="bg-[#B95755] relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#D99B42]/15 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3" />
        ...
        <div className="relative max-w-4xl mx-auto px-6 py-24 md:py-32 text-center scroll-reveal" ref={revealRef3}>
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight" data-testid="text-cta-heading">
            ...
            <br />
            <span className="bg-gradient-to-r from-[#F8E1BF] to-[#D99B42] bg-clip-text text-transparent">More Than You Think</span>
          </h2>
          ...
          <div>
            <Link href={user ? "/app" : "/signup"}>
              <Button size="lg" className="bg-white text-[#B95755] hover:bg-[#F8E1BF] font-semibold rounded-full px-10 py-6 text-lg gap-2 shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300" data-testid="button-join-now">
                Join the Community
